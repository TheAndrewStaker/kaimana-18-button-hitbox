...
#define  _LED_ORDER_FULL
  ...
  #define  LED_DOWN  26
  #define  LED_LEFT  28
  #define  LED_LEFT_TOP  30
  #define  LED_LEFT_MIDDLE  32
  #define  LED_LEFT_BOTTOM  34
...
#define  IDLE_ANIMATION_DELAY       10   // value in miliseconds - use smaller value for faster idle animation playback
#define  T_DELAY      			  250    
