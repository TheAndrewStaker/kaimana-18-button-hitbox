...
int pollSwitches(void)
{
  ...
  kaimana.setLED(LED_LEFT_TOP, BLACK);
  kaimana.setLED(LED_LEFT_MIDDLE, BLACK);
  kaimana.setLED(LED_LEFT_BOTTOM, BLACK);
  iLED[LED_LEFT_TOP] = false;
  iLED[LED_LEFT_MIDDLE] = false;
  iLED[LED_LEFT_BOTTOM] = false;
...
////////
  ...
  // convert P1-P4, K1-K4 into a single unsigned int
